...
include_once ($_SERVER["DOCUMENT_ROOT"] . '/admin/utiles/upload/funciones-imagenes.php');
...
$Proporciones_Archivo = getimagesize($_SERVER["DOCUMENT_ROOT"] . '/admin/temp/' . $filename);
...
$Nuevo_Recorte = $_SERVER["DOCUMENT_ROOT"] . '/admin/temp/recortes/' . $filename;
