                    ...
                    <div class="wrapper">
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <h5>Listado de <strong>Redes Sociales</strong></h5>
                            </header>
                            
                            <?php if ($tienePermiso) {?>
                            
                            <div class="panel-body">
                            	<button onclick="nuevo();" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Nueva Red Social</button>
                            	<br><br>
...
<!--    <script src="js/datatables.js"></script>-->
    ...
    var demoDataTables = function () {
        return {
            init: function () {
                $('.datatable').dataTable({
                    "ajax": "view/redes-listado.php?token=" + usertoken,
    ...
    function editar(id) {
    	window.location="redes-form.php?id=" + id;
    }
    ...
    function nuevo() {
    	window.location="redes-form.php";
    }
