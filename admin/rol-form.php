...
$tienePermiso = (isset($_GET['id']) && $_GET['id'] > 0 ) ? Utiles::validarPermisosAdministrador("admin", "modificar") : Utiles::validarPermisosAdministrador("admin", "agregar");

if ($tienePermiso) {
	
	include_once 'view/rol-form.php';
	
	if (isset($_GET['id']) && $_GET['id'] != '') {
		$accion = "editar";
		$view = new rol_form($_GET['id']);
	} else {
		$accion = "nuevo";
		$view = new rol_form(0);
	}// if-else
...
<body>
                    ...
                    <div class="wrapper">
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <h5><?php echo ((isset($_GET['id'])) ? "Editar" : "Nuevo"); ?> <b>Rol</b></h5>
                            </header>
						</section>
						...
						<div class="row">
                            <div class="col-lg-9">
                                <section class="panel">
                                    <header class="panel-heading">Datos del <strong>Rol</strong></header>
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" action="javascript:void(1);" id="frm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" id="permisos" name="permisos" class="form-control" value="<?php echo $view->item->permisos; ?>" />
                                                </div>
                                            </div>                                            
                                            <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                            	No tiene permisos para la operaci&oacute; que desea realizar.
                            </div>
						</div>
    ...
    function guardar() {
    	$.ajax({
			async:true,
			type: "POST",
			url: "controller/rol-controller.php",
			data: $('#frm').serialize(),
			beforeSend:function(){
    			startLoading();
			},
			success:function(datos) {
				if (datos == '') {					
					window.location="rol-listado.php";
				} else {
					location.hash = '';
					completeLoading();
