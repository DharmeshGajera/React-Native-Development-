                    ...
                    <div class="wrapper">
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <h5>Listado de <strong>Usuarios</strong></h5>
                            </header>
                            
                            <?php if ($tienePermiso) {?>
                            
                            <div class="panel-body">
                            	<button onclick="nuevo();" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Nuevo usuario</button>
                            	<br><br>
...
<!--    <script src="js/datatables.js"></script>-->
    ...
    var demoDataTables = function () {
        return {
            init: function () {
                $('.datatable').dataTable({
                    "ajax": "view/usuario-listado.php?token=" + usertoken,
    ...
    function editar(id) {
    	window.location="usuario-form.php?id=" + id;
    }
    ...
    function nuevo() {
    	window.location="usuario-form.php";
    }

    function clave(id) {
    	URL = 'usuario-modificar-clave-form.php?id=' + id;
