...
if ($tienePermiso) {
	...
	include_once 'view/categoria-form.php';
	
	if (isset($_GET['id']) && $_GET['id'] != '') {
		$accion = "editar";
		$view = new categoria_form($_GET['id']);
	} else {
		$accion = "nuevo";
		$tienePermiso = false;
	}// if-else
                    ...
                    <div class="wrapper">
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <h5><?php echo ((isset($_GET['id'])) ? "Editar" : "Nueva"); ?> <b>Categoria</b></h5>
                            </header>
						</section>
						...
						<div class="row">
                            <div class="col-lg-9">
                                <section class="panel">
                                    <header class="panel-heading">Datos de las <strong>Categorias</strong></header>
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" action="javascript:void(1);" id="frm">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input disabled type="text" id="nombre" name="nombre" class="form-control" value="<?php echo $view->item->nombre; ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Puntos</label>
                                                <div class="col-sm-10">
                                                    <input type="text" id="puntos" name="puntos" class="form-control" value="<?php echo $view->item->puntos; ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    function guardar() {
    	$.ajax({
			...
			success:function(datos) {
				if (datos == '') {					
					window.location="categoria-listado.php";
				} else {
					location.hash = '';
					completeLoading();
