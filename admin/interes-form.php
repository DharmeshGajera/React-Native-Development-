...
if ($tienePermiso) {
	...
	include_once 'view/interes-form.php';
	
	if (isset($_GET['id']) && $_GET['id'] != '') {
		$accion = "editar";
		$view = new interes_form($_GET['id']);
	} else {
		$accion = "nuevo";
		$view = new interes_form(0);
	}// if-else
...
<body>
                    ...
                    <div class="wrapper">
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <h5><?php echo ((isset($_GET['id'])) ? "Editar" : "Nuevo"); ?> <b>Inter&eacute;s</b></h5>
                            </header>
						</section>
						...
						<div class="row">
                            <div class="col-lg-9">
                                <section class="panel">
                                    <header class="panel-heading">Datos de los <strong>Intereses</strong></header>
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" action="javascript:void(1);" id="frm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="jscolor" value="<?php echo $view->item->color; ?>" id="color" name="color">
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    function guardar() {
    	$.ajax({
			async:true,
			type: "POST",
			url: "controller/interes-controller.php",
			data: $('#frm').serialize(),
			beforeSend:function(){
    			startLoading();
			},
			success:function(datos) {
				if (datos == '') {					
					window.location="interes-listado.php";
				} else {
					location.hash = '';
					completeLoading();
