...
$tienePermiso = Utiles::validarPermisosAdministrador("admin", "consultar");
                    ...
                    <div class="wrapper">
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <h5>Datos del <strong>Rol</strong></h5>
                            </header>
                            
                            <?php if ($tienePermiso) {?>
                            
                            <div class="panel-body">
                            	<button onclick="nuevo();" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Nuevo Rol</button>
                            	<br><br>
	                        ...
	                        <div class="row">
	                            <div class="col-lg-12">
	                            	No tiene permisos para la operaci&oacute; que desa realizar.
	                            </div>
							</div>
...
<!--    <script src="js/datatables.js"></script>-->
    ...
    var demoDataTables = function () {
        return {
            init: function () {
                $('.datatable').dataTable({
                    "ajax": "view/rol-listado.php?token=" + usertoken,
    ...
    function editar(id) {
    	window.location="rol-form.php?id=" + id;
    }
