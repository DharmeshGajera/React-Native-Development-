                    ...
                    <div class="wrapper">
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <h5>Listado de <strong>Intereses</strong></h5>
                            </header>
                            
                            <?php if ($tienePermiso) {?>
                            
                            <div class="panel-body">
                            	<button onclick="nuevo();" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Nuevo Inter&eacute;s</button>
                            	<br><br>
...
<!--    <script src="js/datatables.js"></script>-->
    ...
    var demoDataTables = function () {
        return {
            init: function () {
                $('.datatable').dataTable({
                    "ajax": "view/interes-listado.php?token=" + usertoken,
    ...
    function editar(id) {
    	window.location="interes-form.php?id=" + id;
    }
    ...
    function nuevo() {
    	window.location="interes-form.php";
    }
