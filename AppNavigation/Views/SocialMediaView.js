...
export default class SocialMediaView extends React.Component {
	constructor(props) {
		super(props);
	...
	async _getContenido() {
        const response = await APIHelper.get('admin/api/contenido/list_socialmedia.php?id='+global.id);
        this.setState({
            isLoading: false,
    ...
    renderElement() {
    	if(this.state.dataSource){
        	...
        	return(
        		<Text style={Styles.noDataEndpoint}>No hay Redes Sociales</Text>
        	)
        }
    }
				...
				<View style={Styles.container}>
					<View style={[Styles.colView, {height: '100%', width: '100%', flex: 1}]}>
						<View style={{height: 150}}>
	                        <ImageBackground source={require('../Assets/Images/fondo.jpg')} style={Styles.fondoDescripcionContenido}>
	                            <View style={Styles.viewDescripcionContenido}>
		                            ...
		                            <Text style={Styles.subtitleContenido}>Conocé lo Último en Redes del Club de Embajadores.</Text>
	                    ...
	                    <View style={[Styles.rowView, titleIntereses]}>
                            <View>
                                <Text style={{fontFamily: 'GothamBold'}}>Redes Sociales según sus Intereses</Text>
                            </View>
                        </View>
                        { this.renderElement() }
					</View>
